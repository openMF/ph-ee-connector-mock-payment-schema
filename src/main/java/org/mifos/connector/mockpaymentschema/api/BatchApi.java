...
public class BatchApi {
    ...
    @PutMapping(value = "/batches/{batchId}/summary", consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<Void> storeBatchSummary(@PathVariable String batchId, @RequestBody BatchDTO batchDTO) {
        batchDTO.setBatchId(batchId);
        batchService.storeBatchSummary(batchId, batchDTO);
