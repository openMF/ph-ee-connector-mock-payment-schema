...
public class BatchServiceImpl implements BatchService {
    ...
    private Transfer getSingleTransaction(int index, String workflowInstanceKey, String requestId,
                                          TransferStatus status, String batchId){
        ...
        return new Transfer(id, Long.parseLong(workflowInstanceKey), requestId, startedAt, completedAt,
                status, null, null, payeePartyId, payeePartyIdType, null,
                null, null, null, payerPartyId, payerPartyIdType,
                null, null, null, amount, currency, direction,
                null, batchId, null);
    }
}